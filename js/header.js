// docs/js/header.js — Shared header across all pages
(function() {
  ...
  const html = '<div class="qh-bar">'
    ...
    + '<nav class="qh-nav">' + links + '<span class="qh-build">' + BUILD + '</span></nav>'
    + '</div>';
  ...
  css.textContent = ''
    ...
    + '.qh-logo{font-family:"Caveat",cursive;font-size:1.1rem;color:#8B1E47;font-weight:700;text-decoration:none;}'
    + '.qh-nav{display:flex;gap:0.2rem;}'
